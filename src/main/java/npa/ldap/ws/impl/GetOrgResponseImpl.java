 ...
 */
public class GetOrgResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetOrgResponse
{
    
    public GetOrgResponseImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
