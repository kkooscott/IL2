 ...
 */
public class MenuGenerator3Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.MenuGenerator3
{
    
    public MenuGenerator3Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
