 ...
 */
public class GetOrgUsersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetOrgUsers
{
    
    public GetOrgUsersImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
