 ...
 */
public class GetRoleMembersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetRoleMembers
{
    
    public GetRoleMembersImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
