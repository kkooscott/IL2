 ...
 */
public class CheckAuthWithMsgImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.CheckAuthWithMsg
{
    
    public CheckAuthWithMsgImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
