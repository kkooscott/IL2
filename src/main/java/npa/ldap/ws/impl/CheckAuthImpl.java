 ...
 */
public class CheckAuthImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.CheckAuth
{
    
    public CheckAuthImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
