 ...
 */
public class GetOrgDotDnImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetOrgDotDn
{
    
    public GetOrgDotDnImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
