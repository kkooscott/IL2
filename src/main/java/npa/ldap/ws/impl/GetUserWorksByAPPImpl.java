 ...
 */
public class GetUserWorksByAPPImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetUserWorksByAPP
{
    
    public GetUserWorksByAPPImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
