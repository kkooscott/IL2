 ...
 */
public class MenuGenerator2Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.MenuGenerator2
{
    
    public MenuGenerator2Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
