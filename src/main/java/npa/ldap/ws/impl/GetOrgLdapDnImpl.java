 ...
 */
public class GetOrgLdapDnImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetOrgLdapDn
{
    
    public GetOrgLdapDnImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
