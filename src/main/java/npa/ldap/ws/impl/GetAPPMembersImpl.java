 ...
 */
public class GetAPPMembersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetAPPMembers
{
    
    public GetAPPMembersImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
