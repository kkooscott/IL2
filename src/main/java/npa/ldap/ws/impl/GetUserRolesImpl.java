 ...
 */
public class GetUserRolesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements npa.ldap.ws.GetUserRoles
{
    
    public GetUserRolesImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
