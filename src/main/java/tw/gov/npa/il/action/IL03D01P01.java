...
public class IL03D01P01 extends ActionSupport {
  private static final Logger logger = Logger.getLogger(IL03D01P01.class);
  ...
  public String toQuery() throws Exception {
    ...
    this.iltb20OnlineReportList = this.myIltb20OnlineReportDAO.queryDataIL03ByLogUId(LOGUID);
    String preIlRptid = "";
