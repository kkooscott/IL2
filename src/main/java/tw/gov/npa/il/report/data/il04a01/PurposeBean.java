...
public class PurposeBean {
  ...
  public PurposeBean(String level1, String level2, String level3, String code, int sequence, int sequence1, int sequence2) {
    this.level1 = level1;
    this.level2 = level2;
    this.level3 = level3;
    this.code = code;
...
/* Location:              D:\Qian\IL 居留系統\20200529取得最新程式\IL2\WEB-INF\classes\!\tw\gov\npa\il\report\data\il04a01\PurposeBean.class
