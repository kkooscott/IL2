...
public class Builder08A31P {
  public static JRBeanCollectionDataSource build() {
    MyIltb01MainDAO myIltb01MainDAO = new MyIltb01MainDAO();
    List<Iltb01Main> iltb01MainListIsNew = myIltb01MainDAO.getIL08A31PIsNew();
    System.out.println("新增逃逸人數:iltb01MainList=" + iltb01MainListIsNew.size());
    List<Iltb01Main> iltb01MainListIsFound = myIltb01MainDAO.getIL08A31PIsFound();
    System.out.println("當月查獲人數:iltb01MainList=" + iltb01MainListIsFound.size());
    List<Iltb01Main> iltb01MainListIsNow = myIltb01MainDAO.getIL08A31PIsNow();
...
/* Location:              D:\Qian\IL 居留系統\20200529取得最新程式\IL2\WEB-INF\classes\!\tw\gov\npa\il\report\data\il04a01\Builder08A31P.class
