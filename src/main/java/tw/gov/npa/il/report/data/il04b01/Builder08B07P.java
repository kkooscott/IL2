...
public class Builder08B07P {
  public static JRBeanCollectionDataSource build(String whereCondition) {
    ...
    List<YearBean> years = CommonDataGetter.getYear();
    return CommonDataBuilder.buildByYearAndCountry(iltb01MainList, iltb15CountryCodeList, years);
  }
}


/* Location:              D:\Qian\IL 居留系統\20200529取得最新程式\IL2\WEB-INF\classes\!\tw\gov\npa\il\report\data\il04b01\Builder08B07P.class
