...
public class NPALog4J {
    ...
    public int logging(int mesgSendWay, int big5ToUnicode, String LOG_UID, String LOG_DID, String LOG_UIP, String LOG_TDT, String OPR_SVR, String OPR_TDT,
            String OPR_PAGE, String OPR_TYPE, String OPR_SN, String OPR_QEND, String OPR_MEND, String OPR_NAME, String OPR_DN, String OPR_PURP,
            String OPR_COND, String QND_IDNO, String QND_NAME, String QND_BIRTHDT, String QND_CARTYPE, String QND_CARNO, String PAGE_OBJ) {
        String result = logging(LOG_UID.substring(0, 8), LOG_UID.substring(9), LOG_DID, LOG_UIP, LOG_TDT, OPR_SVR, OPR_TDT, OPR_PAGE.contains("-") ? OPR_PAGE : ("系統功能頁面-" + OPR_PAGE), OPR_TYPE, OPR_SN, OPR_QEND, OPR_MEND, OPR_NAME,
                OPR_DN, "", OPR_PURP, "", OPR_COND, QND_IDNO, QND_NAME, QND_BIRTHDT, QND_CARTYPE, QND_CARNO, "", "", "", PAGE_OBJ);
        System.out.println("result:" + result);
        return 0;
    }

    public String logging(String LOG_UID, String LOG_CN, String LOG_DID, String LOG_UIP, String LOG_TDT,
            String OPR_SVR, String OPR_TDT, String OPR_PAGE, String OPR_TYPE, String OPR_SN, String OPR_QEND, String OPR_MEND, String OPR_NAME,
            String OPR_DN, String OPR_KIND, String OPR_PURP, String OPR_CASEID, String OPR_COND, String QND_IDNO, String QND_NAME,
            String QND_BIRTHDT, String QND_CARTYPE, String QND_CARNO, String QND_PHONE, String QND_IMEI, String QND_CASENO, String PAGE_OBJ) {
        String result = "";
...
//            String url = "http://10.100.195.137:8080/NPALogService/sendLogMessage.do";
    ...
    public int logging2(int mesgSendWay, int big5ToUnicode, String LOG_UID, String LOG_DID, String LOG_UIP, String LOG_TDT, String OPR_SVR, String OPR_TDT, String OPR_PAGE, String OPR_TYPE, String OPR_SN, String OPR_QEND, String OPR_MEND, String OPR_NAME, String OPR_DN, String OPR_PURP, String OPR_COND, String QND_IDNO, String QND_NAME, String QND_BIRTHDT, String QND_CARTYPE, String QND_CARNO, String PAGE_OBJ) {
        ...
        return logging(mesgSendWay, big5ToUnicode, LOG_UID, LOG_DID, LOG_UIP, LOG_TDT, OPR_SVR, OPR_TDT, OPR_PAGE, OPR_TYPE, OPR_SN, OPR_QEND, OPR_MEND, OPR_NAME, OPR_DN, OPR_PURP, OPR_COND, QND_IDNO, QND_NAME, QND_BIRTHDT, QND_CARTYPE, QND_CARNO, PAGE_OBJ);
    }
}
