	...
	<%@ include file="util/mask.jsp" %>
		...
		<form id="form1" name="form1" method="post">
			...
			<input id="txtSRCHST" name="txtSRCHST" type="hidden"
				value="${ txtSRCHST }" />
			<display:table id="resultList" name="queryList" pagesize="5" cellpadding="5" 
				requestURI="IL07D03D02.action"
		...
		<div class="FunctionArea" width='100%'>
		<table border='0' width='100%' align='center'><tr><td align='center 'style='text-align:center'>
		<input type="button" value="確　定" onclick="onSubmit();" class="InputButton"/>
		<input type="button"
		...
		<table border=0 cellPadding=0 cellSpacing=0 align=center>
			<TR>
				<TD align=left width="33%">
					...
					<A href="IL07C03D01.action"><img border='0' height='36'
