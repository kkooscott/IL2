...
<s:form id="myForm" action="IL04D01P01.action" style='display:none'>
...
<fieldset>
	...
	<TABLE width="100%" style="align:center;" cellpadding='8'>
		<TR>
		    <TD class='Label'>使用者ID：</TD><TD>${report.id.ilUid}</TD>
		</TR>
		<!--  
		<TR>
		...
		-->
		<TR>
		    <TD class='Label'>報表名稱：</TD><TD>${report.ilRptnm}</TD>
		</TR>
		<TR>
		    <TD class='Label'>條件字串：</TD><TD>${report.ilWhere1}</TD>
		</TR>
		<TR>
		    <TD class='Label'>選取的欄位：</TD><TD>${report.ilShow}</TD>
		</TR>
	</TABLE>
</fieldset>
</td></tr>
