...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function toSubmit() {
		if( !validateNull( $("#txtUVCDBegin").val()) ){ $.alert.open("warning", "大專院校代碼未輸入"); }
			...
			document.form1.action = "IL07C02U02.action";
				...
				<tr>
					<td>
						<div class="FunctionArea">
							...
							<input type="button" onclick="document.location='IL07C02U01.action'" name="btnClear" value="清 除" id="btnClear" class="InputButton" />
							<input type="button"
