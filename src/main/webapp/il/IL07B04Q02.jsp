...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function onSubmit() {
		...
		$('#form1').attr("action", "IL07B04Q02_2.action");
		$('#form1').submit();
...
<%
	...
	String startId=(String)request.getParameter("txtOPCDBegin");
	String endId=(String)request.getParameter("txtOPCDEnd");
%>
	<body>
	<%@ include file="util/mask.jsp" %>
		...
		<form id="form1" name="form1" method="post" class='Form1'>
			...
			<input id="txtOPCD" name="txtOPCD" type="hidden"
				value="${ txtOPCD }" />
			<display:table id="resultList" name="queryList" pagesize="5" cellpadding="8" 
				requestURI="IL07B04Q02.action"
		...
		<input id="txtOPCDBegin" name="txtOPCDBegin" type="hidden" value='<%=request.getParameter("txtOPCDBegin")%>'/>
		<input id="txtOPCDEnd" name="txtOPCDEnd" type="hidden" value='<%=request.getParameter("txtOPCDEnd")%>'/>
		...
		<table border=0 cellPadding=0 cellSpacing=0 align=center>
			<TR>
				<TD align=left width="33%">
					...
					<A href="IL07B02U01.action"><img border='0' height='36'
