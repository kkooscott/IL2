...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function toSubmit() {
		if( !validateNull( $("#txtOPCDBegin").val()) ){ $.alert.open("warning", "職業代碼未輸入"); }
			...
			document.form1.action = "IL07B03D02.action";
				...
				<tr>
					<td>
						<div class="FunctionArea">
							...
							<input type="button" onclick="document.location='IL07B03D01.action'" name="btnClear" value="清 除" id="btnClear" class="InputButton" />
							<input type="button"
