...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function toSubmit() {
		if( !validateNull( $("#txtSRCHSTBegin").val()) ){ $.alert.open("warning", "特殊身份代碼未輸入"); }
			...
			document.form1.action = "IL07D02U02.action";
				...
				<tr>
					<td>
						<div class="FunctionArea">
							...
							<input type="button" onclick="document.location='IL07D02U01.action'" name="btnClear" value="清 除" id="btnClear" class="InputButton" />
							<input type="button"
