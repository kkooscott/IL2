...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function toSubmit() {
		if( !validateNull( $("#txtUVCDBegin").val()) ){ $.alert.open("warning", "大專院校代碼未輸入"); }
		else if( !validateNull( $("#txtUVCDEnd").val()) ){ $.alert.open("warning", "大專院校代碼未輸入"); }
		...
		else if( $("#txtUVCDBegin").val() > $("#txtUVCDEnd").val() ){ $.alert.open("warning", "大專院校代碼範圍輸入錯誤"); }
		else{
			document.form1.action = "IL07C04Q02.action";
						...
						<fieldset>
							...
							<table width="100%" style="align:center;">
								<tr>
									...
									<td width="50%">
										<input id="txtUVCDBegin" name="txtUVCDBegin" type="text"
											class="InputText" size="2" maxLength="4" /> ~ 
										<input id="txtUVCDEnd" name="txtUVCDEnd" type="text"
											class="InputText" size="2" maxLength="4" />
									</td>
								</tr>
							</table>
				...
				<tr>
					<td>
						<div class="FunctionArea">
							...
							<input type="button" onclick="document.location='IL07C04Q01.action'" name="btnClear" value="清 除" id="btnClear" class="InputButton" />
							<input type="button"
