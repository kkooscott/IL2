...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function toSubmit() {
		...
		//else if( !validateFormat( $("#txtUVCDEnd").val(), 0, 4) ){ alert("大專院校代碼為四位數字，例如：0001"); }
			...
			document.form1.action = "IL07D04Q02.action";
				...
				<tr>
					<td>
						<div class="FunctionArea">
							...
							<input type="button" onclick="document.location='IL07D04Q01.action'" name="btnClear" value="清 除" id="btnClear" class="InputButton" />
							<input type="button"
