    ...
    <script type="text/javascript">
        $(window).load(function () {
            if($('#msg').val() != ""){
                alert($('#msg').val());
                $('#msg').val('');
                window.location.replace("IL10A002M.action");
            }

            $('#btnSave').click(function () {
                $('#reportForm').attr("action", "doUpdate09B.action");
                $('#reportForm').submit();
                return false;
            });
                    ...
                    <fieldset>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td width="40%">
                                    <s:textfield name="input.content"
                                                 id="txtCONTENT" class="InputText" style="width:300px;" theme="simple" />
                                </td>
                                <td width="10%" class="Label">
                                    公告種類
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <s:textfield name="input.beginDate" id="txtBEGIN_DT" class="InputText" size="10"
                                                 ...
                                                 onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})" theme="simple"/>
                                    ...
                                    <s:select name="input.beginHour"  id="sHour" list="hours" theme="simple"/>
                                    <s:select name="input.beginMinute"  id="sMinute" list="minutes" theme="simple"/>
                                </td>
                                <td class="Label">
                                    公告結束日期
                                </td>
                                <td>
                                    ...
                                    &nbsp;<img style="cursor: hand"
                                               ...
                                               align="absmiddle" alt="選擇日期" />
                                    <s:select name="input.endHour"  id="eHour" list="hours" theme="simple"/>
                                    <s:select name="input.endMinute"  id="eMinute" list="minutes" theme="simple"/>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
