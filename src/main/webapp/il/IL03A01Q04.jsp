								...
								<table id="table" width="100%" border='0' cellpadding='1' cellspacing='0'>
									...
									<tr>
										...
										<td width="20%">
											...
											<s:elseif test="iltb01Main.ilArcrsn=='H'.toString()">就業PASS</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='I'.toString()">永久居留(梅花卡)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='J'.toString()">專案許可居留證</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='K'.toString()">專案許可永久居留證</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='L'.toString()">永居(連續居留五年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='M'.toString()">就業金卡</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='N'.toString()">永居(依親高級專業人才)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='O'.toString()">永居(依親專業人才五年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='P'.toString()">公司負責人</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='Q'.toString()">投資(創業家簽證)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='R'.toString()">永居(依親特定專業人才三年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='S'.toString()">永居(專業人才五年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='T'.toString()">永居(特定專業人才三年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='U'.toString()">永居(專業人才折抵一年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='V'.toString()">永居(專業人才折抵二年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='W'.toString()">永居(特定專業人才折抵一年)</s:elseif>
											<s:elseif test="iltb01Main.ilArcrsn=='X'.toString()">應聘(第三類外國人)</s:elseif>
										</td>
									...
									<tr>
										...
										<td width="20%">
											...
											<s:elseif test="iltb01Main.ilJbpmcd=='F'.toString()">新北市政府</s:elseif>
											<s:elseif test="iltb01Main.ilJbpmcd=='G'.toString()">宜蘭縣政府</s:elseif>
											<s:elseif test="iltb01Main.ilJbpmcd=='H'.toString()">桃園市政府</s:elseif>
