...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="90%">
			<div class="FuncName">外僑居留資料查詢-警政署查察記事資料畫面</div>
		</td>
	</tr>
</table>
<p></p>	
...
<div id="queryResult" style="width:100%;">
    ...
    <table cellspacing="0" width="90%" id="ListTable" align="center">
        <tr>
            <td>
                <div>	
					<display:table id="resultList" name="queryList" pagesize="10" requestURI="IL03A01Q07.action" decorator="tw.gov.npa.il.decorator.IL03A01Q07Decorator" cellpadding="8" style="width:100%;border-collapse:collapse;">
						<display:column headerClass="First" class="Center sid id" property="id" title="序號" />
